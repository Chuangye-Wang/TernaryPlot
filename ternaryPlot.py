...
class TernaryPlot(object):
    ...
    def zoomin_plot(self, data, axis_range = [], ax = None, color = "r", marker = ".", linewidth = 0, returndata = False, plt_kwargs={}):
        ...
        returndata: true if return the transformed data, default is False
        
        Returns: return if returndata is true.
        """
    ...
    #    data_zoomin = data_zoomin.T
        ax.plot(data_zoomin[:, 0], data_zoomin[:, 1], color = color, marker = marker, linewidth = linewidth, **plt_kwargs)
        if returndata:
            return data_zoomin
...
#                         verticalalignment='center', rotation = label_right_rotation, fontsize = fontsize)        
    ...
    #    print(data_conv)
        ax.plot(x_conv[:, 0], x_conv[:, 1], color = color, marker = marker, linewidth = linewidth, **plt_kwargs)
    
    
    def legend(self, ax = None, labels = [], lg_kwargs = {}):
        """ Add legend to plots
